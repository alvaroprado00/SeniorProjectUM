  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar:  AppBar(
        ...
        title: Text('Recommended', style: getSubheadingStyleWhite(),),
        centerTitle: true,
...
class NewRecommendedCourseForm extends StatefulWidget {
  ...
  @override
  _NewRecommendedCourseFormState createState() => _NewRecommendedCourseFormState();
}
  ...
  Widget build(BuildContext context) {
    ...
    void Function() updateRecommendedCourse=() {
      if(_formKey.currentState!.validate()){
        cc.updateRecommendedCourse(courseID: _controllerCourseID.text).then((val){
          SnackBar snackBar = SnackBar(
            content: Text(val, style: getNormalTextStyleWhite(),),
    ...
    return Form(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            SizedBox(height: 0.27*heightOfScreen,),
            Text('Enter the ID of the course.', style: getNormalTextStyleWhite()),
            ...
            SizedBox(height: 0.35*heightOfScreen,),
