    ...
    return FutureBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot snapshot) {
        if (snapshot.hasData) {
          ...
          return Obx(()=>CourseDescriptionContent(comesFromFeaturePage:true,course: snapshot.data, isSaved: controller.isSaved(courseID: snapshot.data.id), isCurrentCourse: controller.isCurrentCourse(courseID: snapshot.data.id), isCompleted:controller.isCompleted(courseID: snapshot.data.id),));
